 ...
 recognition.onend = () =>setIsListening(false)
  ...
  const handleVoiceCommand = async (command) =>{
    ...
    if (command.includes("what is your name")) {
      const response =
        "Hello Sir I'm Bruno, Your voice assistant created by Ritik Tech";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("hello Bruno")) {
      const response = "Hello Sir I'm Bruno, How can i help you";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("what is your age")) {
      const response = "Hello Sir I'm Bruno, I'm 2 day old";
      speakText(response);
      setInformation(response);
      return;
    }
